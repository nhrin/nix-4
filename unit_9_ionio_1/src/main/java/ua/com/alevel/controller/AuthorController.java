...
public class AuthorController {
    ...
    private void update(BufferedReader reader) {
        try {
            ...
            String name = reader.readLine();
            System.out.println("Enter author's family name ...");
            String famName = reader.readLine();
            author.setName(name);
            author.setFamilyName(famName);
    ...
    private void readAuthor(BufferedReader reader) {
        ...
        try {
            ...
            System.out.println("Books by " + authorService.read(id).getFamilyName() + " " + authorService.read(id).getName());
            for (Book book : bookService.read()) {
                for (int i : book.getAuthorsId()) {
                    if (i == id) System.out.println(book.getName());
                }
            }
