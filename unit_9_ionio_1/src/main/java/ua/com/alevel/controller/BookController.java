...
public class BookController {
    ...
    private void create(BufferedReader reader) {
        ...
        String position;
        System.out.println("Choose authors (enter his id for adding), enter \"up\" when you finish");
        authorController.read();
        List<Integer> list = new ArrayList<>();
        while (!(position = reader.readLine()).equals("up")) {
            System.out.println("please enter your id or \"up\" ...");
    ...
    private void readBook(BufferedReader reader) {
        ...
        int id = Integer.parseInt(idS);
        try {
            System.out.println("Authors for " + "\"" + bookService.read(id).getName() + "\"");
